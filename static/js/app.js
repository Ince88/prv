                ...
                <div style="background: rgba(255, 255, 255, 0.15); border-radius: 10px; padding: 16px; margin-bottom: 12px; backdrop-filter: blur(10px); ${todo.completed || todo.status === 'Closed' ? 'opacity: 0.6;' : ''}">
                    ...
                    ` : `
                        ...
                        <div style="margin-bottom: 12px;">
                            <textarea id="todo-text-${todo.id}" style="
                                width: 100%;
                                padding: 10px;
                                ...
                                min-height: 60px;
                                box-sizing: border-box;
                            " placeholder="Todo description...">${todo.title}</textarea>
                        </div>
                        ...
                        <div style="display: flex; gap: 8px; align-items: center; flex-wrap: wrap;">
                            ...
                            <input type="time" id="new-deadline-time-${todo.id}" value="${todo.deadline && todo.deadline.includes(' ') ? todo.deadline.split(' ')[1].slice(0, 5) : ''}" placeholder="Time" style="
                                padding: 10px;
                                border: none;
                                border-radius: 8px;
                                background: rgba(255, 255, 255, 0.9);
                            ...
                            <button onclick="toggleTimeInput(${todo.id})" style="
                                padding: 10px 16px;
                                background: rgba(255, 255, 255, 0.25);
                                color: white;
...
function toggleTimeInput(todoId) {
    ...
    if (timeInput) {
        if (timeInput.style.display === 'none') {
            ...
            timeInput.value = ''; // Clear time when hiding
        }
    }
}
...
async function updateTodo(todoId) {
    const textArea = document.getElementById(`todo-text-${todoId}`);
